		...
		<div class="row">
			...
			<!-- <div class="columns large-2 medium-4 mobile-hidden">
				<p class="phone">
					...
					<a href='tel: +5411 2061 8689'>2061-8689</a>					
				</p>
			</div> -->
					...
					<div class="row">
						<div class="columns large-6 medium-6" style="float:none; margin:auto">
							<div class="service-description">
								...
								<p>
								 Que recuperar la SEGURIDAD y LIBERTAD de SONREÍR, no tenga nunca una limitación económica. 
								 <p>En DENTUS cada tratamiento tiene su IDENTIDAD y se ajusta a tus posibilidades. </p>
								<p>Estás en manos de especialistas CONFIABLES, TECNOLOGÍA de punta, materiales nacionales e importados y posibilidad de financiación.</p>
								<p style="text-align: center;">
									...
									?>
									<strong><?= strtoupper($monthName) ?> 20% OFF</strong><br>
						...
						<!-- <div class="columns large-4 medium-6 small-6" style="margin-top: 12px">
							<img src="assets/images/temp/implantes_slide1.jpg" alt="">
						</div>
						
						<div class="columns large-4 medium-6 small-6 desktop-hidden" style="margin-top: 12px">
			...
			<div class="section-body">
				...
				<div class="form-appointment">
						...
						<div class="form-body" style="max-width:600px; margin:auto">
							<div class="row">
								...
								<div class="form-actions">
									...
									<input type="hidden" name="especialidad" value="Implantes">
					...
					<div class="banner_ig" style="margin-top:30px; text-align: center;">
						<a href="https://www.instagram.com/dentus.urquiza" target="_blank" title="Seguinos en Instagram" onclick="ga('send', 'event', 'Banner IG', 'Click', 'Implantes');">							
...
<script>
    ...
    function ejecutarPixels() {
		...
		ga('send', 'event', 'Consulta online', 'Enviar', 'Implantes');
