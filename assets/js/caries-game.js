(() => {
  ...
  const draw = () => {
    ...
    context.fillStyle = '#89543b';
    context.beginPath();
    context.ellipse(0, 0, player.radius + 3, player.radius, 0, 0, Math.PI * 2);
    context.fill();
    context.fillStyle = '#a86b49';
    context.beginPath();
    context.arc(-13, -16, 7, 0, Math.PI * 2);
    context.arc(-13, 16, 7, 0, Math.PI * 2);
    context.fill();
    context.fillStyle = '#d9a47b';
    context.beginPath();
    context.ellipse(11, 5, 13, 11, 0, 0, Math.PI * 2);
    context.fill();
    context.fillStyle = '#272322';
    context.beginPath();
    context.arc(13, -5, 4, 0, Math.PI * 2);
    context.fill();
    context.fillStyle = '#fff';
    context.beginPath();
    context.arc(5, -9, 3.2, 0, Math.PI * 2);
    context.fill();
    context.fillStyle = '#272322';
    context.beginPath();
    context.arc(6, -9, 1.25, 0, Math.PI * 2);
    context.fill();
    context.fillStyle = '#fffdf7';
    context.beginPath();
    context.moveTo(13, 7);
    context.quadraticCurveTo(20, 4, 23, 9);
    context.lineTo(22, 18);
    context.quadraticCurveTo(18, 20, 14, 18);
    context.closePath();
    context.fill();
    context.strokeStyle = '#d8cbbd';
    context.lineWidth = 1;
    context.beginPath();
    context.moveTo(18, 8);
