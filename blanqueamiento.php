					...
					<div class="row">
						<div class="columns large-6 medium-6" style="float:none; margin:auto">
							<div class="service-description">
								<h1><span>BLANQUEAMIENTO DENTAL</span></h1>
								<p style="font-size: 18px">
									<b>¡Arrancá el verano con una sonrisa radiente!</b>
								</p>
								<p>
								...
								<p>Estás en manos de especialistas CONFIABLES, TECNOLOGÍA de punta, materiales nacionales e importados y FLEXIBILIDAD en la FINANCIACIÓN.</p>
								<p style="text-align: center;">
									<strong>20% OFF Y CUOTAS</strong>
					...
					<form>
						<header class="form-head row">
							...
							<div class="columns large-12 medium-12">
								<h2 style="font-size: 20px">DEJANOS TU CONSULTA</h2>
						...
						<div class="form-body" style="max-width:600px; margin:auto">
							<div class="row">
								...
								<div class="form-actions">
									...
									<input type="hidden" name="especialidad" value="Blanqueamiento">
...
<script>
    ...
    function ejecutarPixels() {
		...
		ga('send', 'event', 'Consulta online', 'Enviar', 'Blanqueamiento');
